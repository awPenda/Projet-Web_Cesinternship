$(document).ready(function(){
    ...
    $('#create_select_type').change(function(){
        //clear display
        $("#user_attributes").css("display", "none");
        $("#student_attributes").css("display", "none");
        $("#delegate_attributes").css("display", "none");
        $("#pilot_attributes").css("display", "none");
        $("#admin_attributes").css("display", "none");
        $("#compagny_attributes").css("display", "none");
        $("#internship_attributes").css("display", "none");
